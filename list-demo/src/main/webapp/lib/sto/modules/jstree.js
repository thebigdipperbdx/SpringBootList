...
!
    function(a) {
        ...
        if (typeof define === 'function' && define.amd) {
            ...
            layui.define('jquery', function (exports) { //layuiº”‘ÿ
                exports('jstree', a(layui.jquery));
            });
        }
        else {
            a(jQuery);
        ...
        if (!a.jstree) {
            ...
            a.jstree = {
                ...
                redraw_node: function(b, c, d, e) {
                    ...
                    f.state.hidden && (n += " jstree-hidden"), f.state.loaded && !v ? n += " jstree-leaf" : (n += f.state.opened && f.state.loaded ? " jstree-open" : " jstree-closed", b.setAttribute("aria-expanded", f.state.opened && f.state.loaded)), w === f.id && (n += " jstree-last"), b.id = f.id, b.className = n, n = (f.state.selected ? " jstree-clicked" : "") + (f.state.disabled ? " jstree-disabled" : "");
            ...
            a.jstree.plugins.dnd = function(b, c) {
                this.init = function(a, b) {
                    ...
                    if (a = c.redraw_node.apply(this, arguments), a && this.settings.dnd.use_html5) if (this.settings.dnd.large_drag_target) a.setAttribute("draggable", !0);
                    else {
                        var f, g, h = null;
